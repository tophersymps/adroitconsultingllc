...
/**
 * /preview/atlas/[series]/[slug] — auth-gated request-time render of a draft
 * learn lesson. Mirrors /preview/field-notes/[slug] (same gate + PreviewStrip).
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <main id="main" className="flex-1">
          <DraftLocked
            state="signed-out"
            nextPath={`/preview/atlas/${series}/${slug}`}
          />
        </main>
        <Footer />
      </div>
