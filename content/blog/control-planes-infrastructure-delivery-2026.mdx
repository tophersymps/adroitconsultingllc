...
The decision is not "control plane versus Terraform." It is "which jobs belong in a reconciler, and which stay in a pipeline or a workflow," the same [complicated-versus-complex diagnostic](/field-notes/complicated-vs-complex-delivery-diagnostic) we apply to delivery teams. The practical rules we use when advising clients:
