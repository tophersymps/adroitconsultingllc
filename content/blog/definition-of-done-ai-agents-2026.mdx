...
For a consulting team this is a scoping and contracting decision as much as a technical one. The acceptance gate, where the client signs off, now has to include the tripwire and the rollback as part of what done means. [Read the stakeholder piece](/field-notes/stakeholder-management-delivery-bottleneck-2026). Done is not the moment the feature ships. It is the moment the people downstream of the feature know what to do when it misbehaves, and it will misbehave, because it is AI.
