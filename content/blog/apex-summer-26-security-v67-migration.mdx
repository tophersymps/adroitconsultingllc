...
This is the Apex half of the [Summer '26 story](/field-notes/salesforce-summer-26-three-things). If you are here from the Flow or [Agentforce side](/field-notes/flow-orchestrates-agentforce), the security model change lands on your imperative code too, because the Apex actions your agents call and the handler classes your triggers delegate to are exactly what is affected.[^2]
