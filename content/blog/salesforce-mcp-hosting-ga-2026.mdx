...
This article is the implementation view of that GA: what the hosted server exposes, how the security model works, how to stand one up in under thirty minutes, and where the outbound direction (Agentforce reaching external tools) still has rough edges. It builds on our earlier pieces on [Agentforce in production](/field-notes/agentforce-production-implementation-patterns) and [Data 360 implementation](/field-notes/data-360-implementation-patterns); this is the integration layer those articles assumed but did not cover.
