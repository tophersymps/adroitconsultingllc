...
This matters because it changes what "maintained" means. A library that keeps its docs machine-readable lets an AI assistant wire up current components correctly, while one that does not will produce subtly wrong code from older training data. It is the same principle as the [Figma MCP design-to-code workflow](/field-notes/figma-mcp-design-to-code-2026): the tools your developers and designers use are becoming the ground truth agents read.[^5] When you evaluate a component library in 2026, add one line to your checklist: can a coding agent fetch the current API, or is it working from memory?
...
[^5]: Adroit Consulting, "Design-to-Code in 2026: Context Beat Screenshots." [adroit.io](https://adroit.io/field-notes/figma-mcp-design-to-code-2026)
