...
The direction of travel is not subtle. Gartner expects 40 percent of enterprise applications to embed task-specific AI agents by the end of 2026, up from under 5 percent in 2025[^1], and it has projected since 2019 that by 2030, 80 percent of today's project management work will be eliminated as AI takes on data collection, tracking, and reporting[^7]. The scheduling, the tracking, the status summarization, the risk flagging: all of it is becoming machine work.
...
[^7]: Gartner, "Gartner Says 80 Percent of Today's Project Management Tasks Will Be Eliminated by 2030 as AI Takes Over" (March 20 2019). [gartner.com](https://www.gartner.com/en/newsroom/press-releases/2019-03-20-gartner-says-80-percent-of-today-s-project-management)
