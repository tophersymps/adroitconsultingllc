...
On top of those, the ordinary Flow rules still apply: watch flow timeouts, implement fault paths, and remember every agent call is metered consumption, the cost model laid out in our [Agentforce in Practice deep-dive](/field-notes/ai-agents-salesforce) [^8].
...
[^8]: AI Agents Transforming Salesforce: Agentforce in Practice (Adroit Consulting). [adroit.io](https://adroit.io/field-notes/ai-agents-salesforce)
