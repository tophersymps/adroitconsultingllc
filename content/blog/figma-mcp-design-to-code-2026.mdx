...
![Adoption decision rules: teams with no real components start by fixing the file structure, mature teams map Code Connect and generate the rules file, and only with component mapping in place does the custom design-system MCP plus agent graph earn its build cost](</diagrams/figma-mcp-design-to-code-2026/3-decision-rules.png>)
